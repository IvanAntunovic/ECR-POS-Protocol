...
public class ConsoleGUI
{
    ...
    public void start() throws IOException
    {
        ...
        for (Test test : tests)
        {
            ...
            if(count % 2 == 0)
            {
                System.out.println("Press ENTER for next tests...");
                ...
                {
                    System.out.println("Test run has finished sucessfuly with result " + runTestResult + ".");
                }
                else
                {
                    System.out.println(String.format("Test run has not finished successfully with ID: %d", test.getId()) );
                    System.out.println(String.format("Test with %d ID has stopped working at message %d", test, runTestResult[1] ));
                }
